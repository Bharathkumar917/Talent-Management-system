...
resource "aws_s3_bucket" "frontend" {
  bucket = "tms-${var.environment}-frontend-${random_id.suffix.hex}"
  tags   = { Name = "tms-${var.environment}-frontend" }
}
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  tags = { Name = "tms-${var.environment}-cdn" }
}
